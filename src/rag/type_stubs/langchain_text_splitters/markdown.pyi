...
class MarkdownHeaderTextSplitter:
    ...
    def __init__(self, headers_to_split_on: List[Tuple[str, str]], return_each_line: bool = ..., strip_headers: bool = ...) -> None:
...
class ExperimentalMarkdownSyntaxTextSplitter:
    ...
    """
    DEFAULT_HEADER_KEYS = ...
    def __init__(self, headers_to_split_on: Union[List[Tuple[str, str]], None] = ..., return_each_line: bool = ..., strip_headers: bool = ...) -> None:
