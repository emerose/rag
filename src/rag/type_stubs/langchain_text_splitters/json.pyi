...
class RecursiveJsonSplitter:
    ...
    """
    def __init__(self, max_chunk_size: int = ..., min_chunk_size: Optional[int] = ...) -> None:
    ...
    def split_json(self, json_data: Dict[str, Any], convert_lists: bool = ...) -> List[Dict]:
        """Splits JSON into a list of JSON chunks."""
        ...
    
    def split_text(self, json_data: Dict[str, Any], convert_lists: bool = ..., ensure_ascii: bool = ...) -> List[str]:
        """Splits JSON into a list of JSON formatted strings."""
        ...
    
    def create_documents(self, texts: List[Dict], convert_lists: bool = ..., ensure_ascii: bool = ..., metadatas: Optional[List[dict]] = ...) -> List[Document]:
