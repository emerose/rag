...
class HTMLHeaderTextSplitter:
    ...
    """
    def __init__(self, headers_to_split_on: List[Tuple[str, str]], return_each_element: bool = ...) -> None:
    ...
    def split_text_from_url(self, url: str, timeout: int = ..., **kwargs: Any) -> List[Document]:
...
class HTMLSectionSplitter:
    ...
    """
    def __init__(self, headers_to_split_on: List[Tuple[str, str]], xslt_path: Optional[str] = ..., **kwargs: Any) -> None:
...
class HTMLSemanticPreservingSplitter(BaseDocumentTransformer):
    ...
    """
    def __init__(self, headers_to_split_on: List[Tuple[str, str]], *, max_chunk_size: int = ..., chunk_overlap: int = ..., separators: Optional[List[str]] = ..., elements_to_preserve: Optional[List[str]] = ..., preserve_links: bool = ..., preserve_images: bool = ..., preserve_videos: bool = ..., preserve_audio: bool = ..., custom_handlers: Optional[Dict[str, Callable[[Any], str]]] = ..., stopword_removal: bool = ..., stopword_lang: str = ..., normalize_text: bool = ..., external_metadata: Optional[Dict[str, str]] = ..., allowlist_tags: Optional[List[str]] = ..., denylist_tags: Optional[List[str]] = ..., preserve_parent_metadata: bool = ...) -> None:
        """Initialize splitter."""
        ...
