...
class ProgressTracker:
    ...
    def register_task(self, name: str, total: Optional[int] = None) -> None:
        """
    ...
    def update(self, name: str, value: int, total: Optional[int] = None) -> None:
        """
        ...
        if self.callback:
            try:
                ...
                log_message(
                    "WARNING", f"Failed to update progress: {e}", "Progress")
...
def update_progress(name: str, value: int, total: Optional[int] = None,
                   callback: Optional[Callable[[str, int, Optional[int]], None]] = None) -> None:
    """
