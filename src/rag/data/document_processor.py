...
class DocumentProcessor:
    ...
    def process_file(self, file_path: Union[Path, str]) -> List[Document]:
        ...
        try:
            ...
            chunked_docs = self.text_splitter_factory.split_documents(documents, mime_type)
    ...
    def process_directory(self, directory: Union[Path, str]) -> Dict[str, List[Document]]:
