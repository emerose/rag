...
class ResultProcessor:
    ...
    def generate_answer(self, 
        ...
        if system_prompt is None:
            system_prompt = (
                ...
                "rather than making up information. Cite relevant sources in your answer."
            )
        ...
        try:
            ...
            self._log("WARNING", f"API error during answer generation: {e}. Retrying...")
    ...
    def format_answer_with_citations(self, 
        ...
        # Add cited sources
        for i, (source, excerpts) in enumerate(citations.items()):
    ...
    def generate_summary(self, 
        ...
        system_prompt = (
            f"You are a helpful assistant. Summarize the following document concisely. "
            f"Your summary should be objective, informative, and no more than {max_length} words."
        )
        ...
        try:
            ...
            messages = [
                SystemMessage(content=system_prompt),
                HumanMessage(content=f"Please summarize this document:\n\n{combined_text}")
            ]
            ...
            self._log("WARNING", f"API error during summary generation: {e}. Retrying...")
            raise  # Let tenacity retry
