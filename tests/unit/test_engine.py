...
def test_engine_init_with_config(mock_initialize):
...
@patch.object(RAGEngine, '_initialize_from_config', autospec=True)
def test_engine_backward_compatibility(mock_initialize):
...
@patch.object(RAGEngine, '_initialize_from_config', autospec=True)
def test_create_default_config(mock_initialize):
...
def test_initialize_paths(mock_mkdir):
    ...
    with patch.object(RAGEngine, '_initialize_from_config'), \
